...
public sealed class LbcRateAdapter : ICarrierRateAdapter<MockLbcRateResponse>
{
    public ShippingRateResponseDto Adapt(MockLbcRateResponse source)
    {
    ...
    private static DateTime ParseDate(string value)
    {
        ...
        throw new FormatException($"Invalid LBC estimated delivery date format: '{value}'.");
    }
}